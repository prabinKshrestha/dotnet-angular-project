...
@Component({
  selector: 'at-assets-input-multi-select',
  templateUrl: './at-input-multi-select.component.html',
  styleUrls: ['./../at-input.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => ATInputMultiSelectComponent),
      multi: true,
    }
  ],
})

export class ATInputMultiSelectComponent implements ControlValueAccessor {
